...
public class Person {
	...
	public char getFlag_correo() {
		return flag_correo;
	}



	public void setFlag_correo(char flag_correo) {
		this.flag_correo = flag_correo;
	}
	...
	public String toString() {
		return "Person [id=" + id + ", nombre=" + nombre + ", dni=" + dni + ", relacionLaboral=" + relacionLaboral
				...
				+ ", totalBruto=" + totalBruto + ", totalNeto=" + totalNeto + ", correo=" + correo + ", flag_correo="
				+ flag_correo + "]";
	}
